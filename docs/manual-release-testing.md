...
15. [ ] **DIC-002 — Dictation settings/results** — Exercise each displayed dictation mode/provider/language option plus finish/cancel/error paths. → **Expected:** Selection persists, busy state is visible, cancel preserves the prior draft, and failures provide recovery without sending text.
