...
import dev.ipf.whitenoise.android.ui.chats.CHAT_LIST_SEARCH_FILTER_DIALOG_TAG
...
class GlobalSearchFilterScreenshotTest {
    ...
    fun contentFilterDialogSelectedDark() {
        renderFilterPicker(
            state =
                GlobalSearchState(
                    isOpen = true,
                    openFilterCategory = GlobalSearchFilterCategory.Content,
        ...
        composeRule
            .onNodeWithTag(CHAT_LIST_SEARCH_FILTER_DIALOG_TAG)
    ...
    fun folderFilterDialogLight() {
        renderFilterPicker(
            state =
                GlobalSearchState(
                    ...
                    folderFilters = setOf("family"),
                ),
            options =
                GlobalSearchFilterOptions(
                    folders =
                        listOf(
                            GlobalSearchFolderOption("family", "Family"),
                            GlobalSearchFolderOption("work", "Work"),
                        ),
                ),
            darkTheme = false,
        )
        composeRule
            .onNodeWithTag(CHAT_LIST_SEARCH_FILTER_DIALOG_TAG)
            .captureRoboImage("src/test/snapshots/global_search_folder_filter_dialog_light.png")
    }
