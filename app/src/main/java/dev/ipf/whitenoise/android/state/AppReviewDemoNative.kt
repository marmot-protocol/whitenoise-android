...
internal class AppReviewDemoNative(private val appState: WhiteNoiseAppState) : ReviewDemoBackend {
    ...
    override val foregroundReady: Boolean
        get() =
            appState.appInForeground && appState.phase == AppPhase.Ready &&
    ...
    override suspend fun existingDirectConversation(ref: String, peerId: String): String? {
    ...
    override suspend fun invitation(ref: String, groupId: String): ReviewDemoInvitation? =
    ...
    override suspend fun acceptInvitation(ref: String, groupId: String) {
        try {
    ...
    override suspend fun timeline(ref: String, groupId: String): List<ReviewDemoMessage> =
        appState.marmotIo {
            timelineMessages(
                ref,
    ...
    override suspend fun activate(ref: String, stillOwned: () -> Boolean): Boolean =
        appState.setActiveAccount(ref, shouldActivate = stillOwned)
