...
/** Keeps command labels readable at large font scales within the native clickable action. */
@Composable
internal fun MessageActionButton(
    ...
    TextButton(
        ...
        Row(
            ...
            // Allocate the remaining row width before measuring wrapped labels.
