 ...
 * via [BuildConfig.WHITENOISE_PUSH_SERVER_PUBKEY_HEX] and
 * [BuildConfig.WHITENOISE_PUSH_RELAY_HINT]. When the pubkey is unset the
...
data class PushServerConfig(
    ...
    companion object {
         ...
         * (no `WHITENOISE_PUSH_SERVER_PUBKEY_HEX` set). A blank or
         ...
         */
        fun current(): PushServerConfig? = fromRaw(BuildConfig.WHITENOISE_PUSH_SERVER_PUBKEY_HEX, BuildConfig.WHITENOISE_PUSH_RELAY_HINT)
