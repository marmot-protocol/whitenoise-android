...
private fun ConversationDictationActiveActions(controller: ConversationDictationController) {
    ...
    IconButton(
        ...
        Icon(
            ...
            contentDescription = stringResource(if (paused) R.string.dictation_resume else R.string.dictation_pause),
        )
    }
    IconButton(
...
private fun dictationFailureLabel(reason: ConversationDictationFailure): String =
    stringResource(
        when (reason) {
            ...
            ConversationDictationFailure.ProviderAccessRejected -> R.string.dictation_provider_access_rejected
