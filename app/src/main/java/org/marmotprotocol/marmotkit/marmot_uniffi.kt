...
package org.marmotprotocol.marmotkit
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_marmot_uniffi_checksum_method_marmot_watch_agent_text_stream() != 57255.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
data class AppMessageRecordFfi (
    ...
    var `appMessage`: AppMessagePayloadFfi?, 
...
public object FfiConverterTypeAppMessageRecordFfi: FfiConverterRustBuffer<AppMessageRecordFfi> {
    override fun read(buf: ByteBuffer): AppMessageRecordFfi {
        return AppMessageRecordFfi(
            ...
            FfiConverterString.read(buf),
            FfiConverterString.read(buf),
            FfiConverterOptionalTypeAppMessagePayloadFfi.read(buf),
            FfiConverterULong.read(buf),
            FfiConverterULong.read(buf),
        )
    }
    ...
    override fun allocationSize(value: AppMessageRecordFfi) = (
            ...
            FfiConverterOptionalTypeAppMessagePayloadFfi.allocationSize(value.`appMessage`) +
    ...
    override fun write(value: AppMessageRecordFfi, buf: ByteBuffer) {
            ...
            FfiConverterOptionalTypeAppMessagePayloadFfi.write(value.`appMessage`, buf)
 ...
 */
sealed class AppMessagePayloadFfi {
    
    data class Reaction(
        val `targetMessageId`: kotlin.String, 
        val `emoji`: kotlin.String, 
        val `removed`: kotlin.Boolean) : AppMessagePayloadFfi() {
        companion object
    }
    
    data class Delete(
        val `targetMessageId`: kotlin.String) : AppMessagePayloadFfi() {
        companion object
    }
    ...
    data class Media(
        ...
        val `caption`: kotlin.String?) : AppMessagePayloadFfi() {
        companion object
    }
    
    data class Reply(
        val `targetMessageId`: kotlin.String, 
        val `text`: kotlin.String) : AppMessagePayloadFfi() {
        companion object
    }
 ...
 * @suppress
 */
public object FfiConverterTypeAppMessagePayloadFfi : FfiConverterRustBuffer<AppMessagePayloadFfi>{
    override fun read(buf: ByteBuffer): AppMessagePayloadFfi {
        return when(buf.getInt()) {
            1 -> AppMessagePayloadFfi.Reaction(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                FfiConverterBoolean.read(buf),
                )
            2 -> AppMessagePayloadFfi.Delete(
                FfiConverterString.read(buf),
                )
            3 -> AppMessagePayloadFfi.Retry(
                FfiConverterString.read(buf),
                )
            4 -> AppMessagePayloadFfi.Media(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                FfiConverterULong.read(buf),
                FfiConverterOptionalString.read(buf),
                )
            5 -> AppMessagePayloadFfi.Reply(
                FfiConverterString.read(buf),
                FfiConverterString.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
    ...
    override fun allocationSize(value: AppMessagePayloadFfi) = when(value) {
    ...
    override fun write(value: AppMessagePayloadFfi, buf: ByteBuffer) {
        when(value) {
            is AppMessagePayloadFfi.Reaction -> {
                buf.putInt(1)
...
sealed class MessageUpdateFfi {
    ...
    data class AgentStreamFinalized(
        val `received`: RuntimeMessageReceivedFfi) : MessageUpdateFfi() {
        companion object
    }
...
public object FfiConverterTypeMessageUpdateFfi : FfiConverterRustBuffer<MessageUpdateFfi>{
    override fun read(buf: ByteBuffer): MessageUpdateFfi {
        return when(buf.getInt()) {
            ...
            3 -> MessageUpdateFfi.AgentStreamFinalized(
                FfiConverterTypeRuntimeMessageReceivedFfi.read(buf),
                )
            else -> throw RuntimeException("invalid enum value, something is very wrong!!")
        }
    ...
    override fun allocationSize(value: MessageUpdateFfi) = when(value) {
        ...
        is MessageUpdateFfi.AgentStreamFinalized -> {
            // Add the size for the Int that specifies the variant plus the size needed for all fields
            (
                4UL
                + FfiConverterTypeRuntimeMessageReceivedFfi.allocationSize(value.`received`)
 ...
 * @suppress
 */
public object FfiConverterOptionalTypeAppMessagePayloadFfi: FfiConverterRustBuffer<AppMessagePayloadFfi?> {
    override fun read(buf: ByteBuffer): AppMessagePayloadFfi? {
        if (buf.get().toInt() == 0) {
            return null
        }
        return FfiConverterTypeAppMessagePayloadFfi.read(buf)
    }

    override fun allocationSize(value: AppMessagePayloadFfi?): ULong {
        if (value == null) {
            return 1UL
        } else {
            return 1UL + FfiConverterTypeAppMessagePayloadFfi.allocationSize(value)
        }
    }
    ...
    override fun write(value: AppMessagePayloadFfi?, buf: ByteBuffer) {
        if (value == null) {
            ...
            buf.put(1)
            FfiConverterTypeAppMessagePayloadFfi.write(value, buf)
        }
    }
}
