...
object Bip340ComparisonBridge {
    ...
    fun legacyRejectsInvalidSignature(): Boolean =
        !LegacyBip340BenchmarkVerifier.verify(PUBLIC_KEY, MESSAGE, INVALID_SIGNATURE)
    ...
    fun replacementRejectsMutatedEvent(): Boolean =
        !NostrEventVerifier.verifies(SIGNED_EVENT.copy(content = "mutated"))
